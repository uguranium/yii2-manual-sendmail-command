...
<!--<![endif]-->
    ...
    <div style="Margin-left: 20px;Margin-right: 20px;">
      <p class="size-16" style="Margin-top: 16px;Margin-bottom: 20px;font-size: 16px;line-height: 24px; " lang="x-size-16">
        companyx Rentals uniteddan son eklenen kullanıcı ve gonderilen maillerin bilgisi.
        ...
        <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0"><tr class="layout-email-footer"><td style="width: 600px;" class="w560"><![endif]-->
          <div class="column" style='text-align: left;font-size: 12px;line-height: 19px;color: #b9b9b9;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
              <div>
                <a style="text-decoration: none; color: #cccccc" href="https://www.facebook.com/companyx" target="_blank">Facebook</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://twitter.com/companyx" target="_blank">Twitter</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://plus.google.com/u/0/+companyx/about" target="_blank">Google+</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://www.youtube.com/channel/companyx" target="_blank">Youtube</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://www.instagram.com/companyx/" target="_blank">Instagram</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://new.vk.com/companyx" target="_blank">VKontakte</a> |

                <div style="float: right; color: #cccccc;">companyx.com</div>
              </div>
            </div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
