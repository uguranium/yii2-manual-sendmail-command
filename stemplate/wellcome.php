...
<!--<![endif]-->
    <div class="wrapper" style="min-width: 320px;background-color: #f5f7fa;" lang="x-wrapper">
      <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 173040px);">
        ...
        <!--[if (mso)|(IE)]></td><td style="width: 280px" valign="top"><![endif]-->
          <div class="webversion" style='Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #b9b9b9;font-family: "Open Sans",sans-serif;'>
            <p style="Margin-top: 0;Margin-bottom: 0;">Dream. Book. Discover.</p>
          </div>
      ...
      <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #307fb0;background-position: 0px 0px;background-repeat: repeat;">
        <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0"><tr class="layout-fixed-width" style="background-color: #307fb0;background-position: 0px 0px;background-repeat: repeat;"><td style="width: 600px" class="w560"><![endif]-->
      ...
      <h1 class="size-40" style="Margin-top:15px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #44a8c7;font-size: 32px;line-height: 40px;font-family: Cabin,Avenir,sans-serif;text-align: center;" lang="x-size-40"><strong><span style="color:#ffffff">ComapnyX</span></strong></h1><p class="size-20" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 17px;line-height: 26px;text-align: center;" lang="x-size-20"></p>
    </div>
    ...
    <div style="Margin-left: 20px;Margin-right: 20px;">
      <p class="size-16" style="Margin-top: 16px;Margin-bottom: 20px;font-size: 16px;line-height: 24px; " lang="x-size-16">
        ...
        And thanks for joining our global communty! Here is a your login information to ComapnyX.com .
    ...
    <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
      <div style="Margin-left: 20px;Margin-right: 20px;">
        ...
        <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
          <![if !mso]><a style='border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;background-color: #44a8c7; color: #ffffff; font-family: &#39;Open Sans&#39;, sans-serif !important;font-family: "Open Sans",sans-serif;' href="https://ComapnyX.com/en" target="_blank">LOGIN</a><![endif]>
          <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="https://ComapnyX.com" style="width:152px" arcsize="9%" fillcolor="#44a8c7" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#ffffff;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">LOGIN</center></v:textbox></v:roundrect><![endif]--></div>
      </div>
    </div>
        ...
        <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0"><tr class="layout-email-footer"><td style="width: 600px;" class="w560"><![endif]-->
          <div class="column" style='text-align: left;font-size: 12px;line-height: 19px;color: #b9b9b9;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
              <div>
                <a style="text-decoration: none; color: #cccccc" href="https://www.facebook.com/ComapnyX" target="_blank">Facebook</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://twitter.com/ComapnyX" target="_blank">Twitter</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://plus.google.com/u/0/+ComapnyX/about" target="_blank">Google+</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://www.youtube.com/channel/ComapnyX" target="_blank">Youtube</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://www.instagram.com/ComapnyX/" target="_blank">Instagram</a> |
                <a style="text-decoration: none; color: #cccccc" href="https://new.vk.com/ComapnyX" target="_blank">VKontakte</a> |

                <div style="float: right; color: #cccccc;">ComapnyX.com</div>
              </div>
            </div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
